...
/** @hidden */
export declare class PickerBase<PropType extends IPickerProps, StateType extends IPickerState, RepType> extends BaseComponent<PropType, StateType> {
    static defaults: any;
    /** @hidden */
     ...
     */
    protected _inst?: PickerBase<PropType, StateType, RepType>;
