...
import { IScrollerRepresentation, IScrollerValidateArgs, IWheelMoveArgs, MbscScrollerWheel } from '../scroller/scroller.types';
import { MbscSelectOptions } from './select.types.public';
type ISelectValue = string | number | object | any;
...
export declare class SelectBase extends BaseComponent<MbscSelectOptions, any> {
    ...
    /** @hidden */
    _onWheelMove: ({ wheelIndex, selection, dataItem }: IWheelMoveArgs) => any[] | undefined;
    /** @hidden */
    ...
    close(): void;
    /** @hidden */
    _format: (valueRep: IScrollerRepresentation) => string;
    /**
     * @hidden
     ...
     */
    _parse: (value: any) => IScrollerRepresentation;
    /** @hidden */
    _get: (valueRep: IScrollerRepresentation) => ISelectValue;
    /** @hidden */
    _valueEquals: (v1: any, v2: any) => boolean;
    /** @hidden */
    _validate: ({ values, direction, wheels, index }: IScrollerValidateArgs) => {
        disabled?: object[] | undefined;
        valid?: IScrollerRepresentation | undefined;
        indexes?: IScrollerRepresentation | undefined;
    };
    /** @hidden */
