...
export type TDatepickerControl = 'calendar' | 'date' | 'time' | 'datetime' | 'timegrid';
...
/** @hidden */
export declare class DatepickerBase extends PickerBase<MbscDatepickerOptions, MbscDatepickerState, IDValueRepresentation> {
    /** @hidden */
