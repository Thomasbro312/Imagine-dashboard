...
import { IDailyData, IDayData } from './schedule-timeline-base.types';
...
}, start: Date, end: Date, allDay: boolean | undefined, isTimeline: boolean | undefined, invalidateEvent: 'start-end' | 'strict' | undefined, exclusiveEndDates?: boolean): MbscCalendarEvent | boolean;
